...
const WriteFlexPeople = ({ compName, data, handleShow }) => {
  //console.log(compName, data, handleShow);
          ...
          <span id="dotswrite">
            {data?.map((item, index) => {
              ...
              return (
                ...
                >
                  <a>
                    {compName === 'People' ? (`${item.first_name} ${item.last_name}`).toUpperCase()
                      : compName === 'Security' ? (`${item.role}`).toUpperCase()
                        : compName === 'doctypes' ? (`${item.doc_name}`).toUpperCase()
                        : compName === 'template' ? (`${item.quote_name}`).toUpperCase()
                          : ''}
                  </a>
                </li>
              );
...
export default WriteFlexPeople
