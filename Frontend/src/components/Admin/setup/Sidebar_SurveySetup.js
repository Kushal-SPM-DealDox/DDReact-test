...
const Sidebar_SurveySetup = (props, { showPlusIcon }) => {
        ...
        <div>
            <div className="leftwrite" style={{ position: 'fixed' }}>
                        ...
                        <span id="dotswrite">
                            ...
                            {lookupsData?
                               ...
                               lookupsData.map((lookups) => (
                                <li key={lookups.survey_key}>
                                    <Link to={'/setup/'+lookups.survey_key} state={lookups} >
                                        {lookups.title}
                                    </Link>
                                </li>
                               ))
                ...
                <div class="plusiconlookups" style={{ marginTop: "0px" }}>
                    <Link to='/setup/create'><i class="fa fa-plus"></i></Link>
                </div>
                {/* )} */}
...
export default Sidebar_SurveySetup
