...
import { FaBook, FaClipboard, FaClone, FaEye, FaPenSquare, FaShoppingCart, FaStamp } from 'react-icons/fa';
...
const CatalogSidebar = ({ children }) => {
  ...
  const menuItem = [
    ...
    },
    {
      ...
      active: location.pathname === "/rolessetup" || location.pathname === "/rolesratecards" || location.pathname === "/rolesexchange"
    },
    {
      path: "/rolessetup",
      ...
      <div className='sidebarfix'>
        <div className="sidebar">
          ...
          {menuItem.map((item, index) => {
            ...
            if (item.onClick) {
              return (
                <div key={index} className={`link ${item.active ? 'active' : ''}`} onClick={item.onClick}>
